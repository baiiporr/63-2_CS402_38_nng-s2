                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="save-qrcodeline.php" name="form1" method="post"
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    $query = "SELECT * FROM file_qrline" or die("Error:");
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td><a href='deleteQrcode.php?Qrline_id=$row[0]' onclick=\"return confirm('คุณต้องการลบบันทึกนี้')\">ลบ</a></td> ";
                                        echo "</tr>";
                                    }
                                    echo "</table>";
                                    //5. close connection
