            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">กรอกปีการศึกษา</h1>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">เจ้าหน้าที่กรอกปีการศึกษา</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row form-group">
                                            <label class="text-center col-md-3 control-label">กรอกปีการศึกษา</label>
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <i class="glyphicon glyphicon-user"></i>
                                                    </span>
                                                    <input id="year" name="year" value="" class="form-control input-md"
                                                        type="text">
                                                </div>
                                            </div>
                                        </div>
