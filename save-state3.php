...
$select = "SELECT * FROM state3 WHERE Student_ID = '$student_id' AND term = '$term' AND year = '$year'";
...
if ($count == 0) {
    $insert = "INSERT INTO state3 (Student_ID, term, year, Status)
    ...
    $update = "UPDATE state3 SET term = '$term', year ='$year', Status='$status'
