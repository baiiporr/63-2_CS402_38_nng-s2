                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="excelToarrayloan.php" name="form1" method="post"
                                            enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">ไฟล์รายงานการกู้ยืม</label>
                                                <input class="form-control" type="file" name="fileToUploadarrayloan"
                                                    id="fileToUploadarrayloan">
                                            </div>
                                            <div class="col-md-12 text-center">

                                                <input type="submit" class=btncolor:black value="บันทึกไฟล์ลงระบบ"
                                                    id="submitaddfilelone" name="submitaddfilelone"
                                                    class="btn ass_btn  ">
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<a  href=uplodefilelone/$excelfileLoan>$excelfileLoan</a>";
                                                echo "<a href='deleteExcelFilearrayloan.php?arrayLoan_id=$row[0]' onclick=\"return confirm('คุณต้องการลบบันทึกนี้')\"> ลบ</a> <br> ";
                                            }
                                            ?>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="excelToarraybank.php" name="form1" method="post"
                                            enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">ไฟล์รายงานการกู้ยืม</label>
                                                <input class="form-control" type="file" name="fileToUploadarraybank"
                                                    id="fileToUploadarraybank">
                                            </div>
                                            <div class="col-md-12 text-center">

                                                <input type="submit" class=btncolor:black value="บันทึกไฟล์ลงระบบ"
                                                    id="submitaddfilebank" name="submitaddfilebank"
                                                    class="btn ass_btn  ">
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                            //ไฟล์pdf
                                            //2. query ข้อมูลจากตาราง: 
                                            $query = "SELECT * FROM file_report_bank" or die("Error:");
                                            //3.เก็บข้อมูลที่ query ออกมาไว้ในตัวแปร result . 
                                            $result = mysqli_query($objConnect, $query);
                                            //4 . แสดงข้อมูลที่ query ออกมา โดยใช้ตารางในการจัดข้อมูล: 
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<a  href=uplodefilebank/$excelfilebank>$excelfilebank</a>";
                                                echo "<a href='deleteExcelFilearraybank.php?arrayBank_id=$row[0]' onclick=\"return confirm('คุณต้องการลบบันทึกนี้')\"> ลบ</a> <br> ";
                                            }
                                            ?>
                                    </div>
                                </div>
