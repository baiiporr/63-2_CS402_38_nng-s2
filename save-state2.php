...
$select = "SELECT * FROM state2 WHERE Student_ID = '$student_id' AND term = '$term' AND year = '$year'";
...
if ($count == 0) {
    $insert = "INSERT INTO state2 (Student_ID, term, year, Status)
    ...
    $update = "UPDATE state2 SET term = '$term', year ='$year', Status='$status'
