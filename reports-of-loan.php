...
<head>
    ...
    <title>สรุปรายงานการกู้ยืม</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">อัพโหลดไฟล์สรุปรายงานการกู้ยืม</h1>
                        <div class="row">
                            <!--คลิกเพื่อโหลดไฟล์สรุปรายงานแบบมีคู่-->
                                ...
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div
                                                    class="text-base font-weight-bold text-warning text-uppercase mb-1">
                                                    สรุปรายงานการกู้ยืม (แบบมีคู่)</div>
                                                <a class="btn btn-outline-warning" ;
                                                    href="mapping.php">ดูไฟล์สรุปรายงานการกู้ยืม (แบบมีคู่)</a>
                                            </div>
                            ...
                            <!--คลิกเพื่อโหลดไฟล์สรุปรายงานแบบไร้คู่-->
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div
                                                    class="text-base font-weight-bold text-warning text-uppercase mb-1">
                                                    สรุปรายงานการกู้ยืม (แบบไร้คู่)</div>
                                                <a class="btn btn-outline-warning" ;
                                                    href="notmapping.php">ดูไฟล์สรุปรายงานการกู้ยืม (แบบไร้คู่)</a>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">
                                            เจ้าหน้าอัพโหลดไฟล์รายงานการกู้ยืมจากระบบ e-Studentloan</h6>
                                    </div>
                                    <div class="card-body">
                                        <form action="excelToSQLloan.php" name="form1" method="post"
                                            enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">ไฟล์รายงานการกู้ยืม</label>
                                                <input class="form-control" type="file" name="fileToUploadSQLloan"
                                                    id="fileToUploadSQLloan">
                                            </div>
                                            <div class="col-md-12 text-center">

                                                <input type="submit" class=btncolor:black value="บันทึกไฟล์ลงระบบ"
                                                    id="submitaddfileSQLlone" name="submitaddfileSQLlone"
                                                    class="btn ass_btn  ">
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">ไฟล์ excel ที่อัพโหลดเสร็จสิ้น
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <!-- แสดงไฟล์PDF -->
                                        <?php
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<a  href=uplodefileloanSQL/$excelfileLoan>$excelfileLoan</a>";
                                                echo "<a href='deleteExcelSQLloan.php?sqlLoan_id=$row[0]' onclick=\"return confirm('คุณต้องการลบบันทึกนี้')\"> ลบ</a> <br> ";
                                            }
                                            ?>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">
                                            เจ้าหน้าอัพโหลดไฟล์รายงานการกู้ยืมจากธนาคาร
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <form action="excelToSQLbank.php" name="form1" method="post"
                                            enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">ไฟล์รายงานการกู้ยืม</label>
                                                <input class="form-control" type="file" name="fileToUploadSQLbank"
                                                    id="fileToUploadSQLbank">
                                            </div>
                                            <div class="col-md-12 text-center">

                                                <input type="submit" class=btncolor:black value="บันทึกไฟล์ลงระบบ"
                                                    id="submitaddfileSQLbank" name="submitaddfileSQLbank"
                                                    class="btn ass_btn  ">
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                $excelfilebank = $row['file_name'];
                                                echo "<a  href=uplodefilebankSQL/$excelfilebank>$excelfilebank</a>";
                                                echo "<a href='deleteExcelSQLbank.php?sqlBank_id=$row[0]' onclick=\"return confirm('คุณต้องการลบบันทึกนี้')\"> ลบ</a> <br> ";
                                            }
                                            ?>
                                    </div>
                                </div>
