...
<head>
    ...
    <title>อัพโหลดไฟล์รูป และ ไฟล์ pdf สำหรับตารางกำหนดการ</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">อัพโหลดไฟล์รูป และ ไฟล์ pdf สำหรับตารางกำหนดการ</h1>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">เจ้าหน้าที่อัพโหลดไฟล์ PDF </h6>
                                    </div>
                                    <div class="card-body">
                                        <form action="savepdf-schedule.php" name="form1" method="post"
                                            enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="formFile"
                                                    class="form-label">ไฟล์ตารางกำหนดการ(แสดงเพียงแค่PDFเท่านั้น)</label>
                                            ...
                                            <div class="col-md-12 text-center">
                                                ...
                                                <input type="submit" class=btncolor:black value="บันทึกไฟล์ลงระบบ"
                                                    id="submitaddfile" name="submitaddfile" class="btn ass_btn  ">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<a  href=pdftable/$pdffile>$pdffile</a>";
                                                echo "<a href='deletePDF.php?PDF_id=$row[0]' onclick=\"return confirm('คุณต้องการลบบันทึกนี้')\"> ลบ</a> <br> ";
                                            }
                                            ?>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">เจ้าหน้าที่อัพโหลดรูปภาพ </h6>
                                    </div>
                                    <div class="card-body">
                                        <form action="savepic-schedule.php" name="form1" method="post"
                                            enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="formFile"
                                                    class="form-label">รูปภาพตารางกำหนดการ(แสดงเพียงแค่
                                                    รูปภาพเท่านั้น)</label>
                                                <input class="form-control" type="file" name="fileToUpload1"
                                                    id="fileToUpload1">
                                            </div>
                                            <div class="col-md-12 text-center">

                                                <input type="submit" class=btncolor:black value="บันทึกรูปลงระบบ"
                                                    id="submitaddpic" name="submitaddpic" class="btn ass_btn ">
                                            </div>
                                    </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">ไฟล์ รูปภาพ ที่อัพโหลดเสร็จสิ้น</h6>
                            </div>
                            <div class="card-body">
                                <?php
                                    $query = "SELECT * FROM file_pictable" or die("Error:");
                                    //3.เก็บข้อมูลที่ query ออกมาไว้ในตัวแปร result . 
                                    $result = mysqli_query($objConnect, $query);
                                    //4 . แสดงข้อมูลที่ query ออกมา โดยใช้ตารางในการจัดข้อมูล: 
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        $pdffile = $row['file_name'];
                                        echo "<tr>";
                                        echo "<td>" . "<img src='pictable/" . $row["file_name"] . "' width='500'>" . "</td>";
                                        echo "<td><a href='deletePictable.php?Pictable_id=$row[0]' onclick=\"return confirm('คุณต้องการลบบันทึกนี้')\">ลบ</a></td> ";
                                        echo "</tr>";
                                    }
                                    echo "</table>";
                                    //5. close connection
